...
export const RESULT_CONTENT: Record<ResultPattern, ResultContent> = {
  MEDO: {
    ...
    signs: ['Pensamentos que começam com “e se...?”', 'Tendência a imaginar o pior cenário', 'Necessidade de controle', 'Evita oportunidades por receio das consequências', 'Dificuldade para tomar decisões'],
