...
export const RESULT_CONTENT: Record<ResultPattern, ResultContent> = {
  ...
  INSEGURANÇA: {
    ...
    interpretation: [
      'Suas respostas sugerem que a percepção sobre si mesmo pode estar interferindo em algumas escolhas. A insegurança pode surgir através da comparação, do medo de errar ou da necessidade de aprovação. Ao reconhecer isso, você pode resgatar sua confiança interna e agir com mais autenticidade.',
    ],
    signs: ['Autocrítica intensa', 'Comparação frequente', 'Dificuldade em receber elogios', 'Necessidade de confirmação externa', 'Abandona ideias por duvidar de si'],
    effects: ['Baixa autoestima', 'Perda de oportunidades', 'Dependência da aprovação alheia', 'Sensação de não ser suficiente', 'Desgaste emocional e frustração'],
    ...
    practices: ['Registre 3 conquistas diárias (por menores que sejam)', 'Identifique e questione sua voz crítica', 'Pratique o autocuidado sem cobrança', 'Cerque-se de pessoas que te apoiam e valorizam'],
  ...
  PROCRASTINAÇÃO: {
    ...
    interpretation: [
      'Suas respostas sugerem uma tendência ao adiamento de determinadas ações. A procrastinação nem sempre significa falta de vontade. Ela pode aparecer quando uma tarefa desperta desconforto, medo de falhar, perfeccionismo, insegurança ou a sensação de sobrecarga. É importante compreender o que acontece emocionalmente antes do adiamento.',
    ],
    cycle: 'adiamento → alívio momentâneo → cobrança → culpa → mais dificuldade para começar',
    signs: ['Tarefas constantemente adiadas', 'Espera pelo “momento certo”', 'Dificuldade para começar', 'Muitas ideias e pouca execução', 'Sensação de culpa depois de adiar'],
    effects: ['Acúmulo de responsabilidades', 'Ansiedade e estresse', 'Frustração com você mesmo', 'Perda de oportunidades', 'Sensação de estar sempre “atrasado”'],
    ...
    practices: ['Divida grandes tarefas em passos pequenos', 'Use a técnica dos 10 minutos (comece sem se cobrar tanto)', 'Elimine distrações no momento da ação', 'Celebre cada etapa concluída', 'Observe e acolha as emoções que surgem antes do adiamento'],
    quote: 'Disciplina é escolher o que você mais quer, no lugar do que você quer agora.',
  },
};
