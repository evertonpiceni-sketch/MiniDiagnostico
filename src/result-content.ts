...
// Conteúdo literal aprovado por Janaína em 14/09/2026.
export const RESULT_CONTENT: Record<ResultPattern, ResultContent> = {
  "MEDO": {
    ...
    "signs": [
      "Imaginar primeiro o que pode dar errado",
      "Recuar diante de mudanças ou exposição",
      "Buscar garantias antes de agir",
      "Permanecer no conhecido por parecer mais seguro",
      "Deixar oportunidades passarem por receio das consequências"
    ],
    "effects": [
      ...
      "Frustração por saber que deseja avançar, mas continuar recuando"
    ],
    ...
    "path": [
      "Escolha uma situação que você vem evitando e pergunte:",
      "Qual é o menor passo que posso dar agora sem precisar ter certeza de tudo?",
      "Não tente resolver a situação inteira. Escolha uma ação pequena, concreta e possível nas próximas 24 horas."
    ],
    "practices": [
      "Observe quando sua mente começa a antecipar o pior",
      "Identifique o que você está tentando controlar ou garantir",
      "Diferencie risco real de antecipação mental",
      "Escolha uma pequena ação mesmo sem certeza absoluta",
      "Registre cada vez que avançar apesar do medo"
    ],
    "quote": "Você não precisa ter certeza de que vai dar certo para se permitir dar o próximo passo."
  },
  "INSEGURANÇA": {
    ...
    "signs": [
      ...
      "Sentir que ainda precisa se preparar mais",
      "Buscar confirmação externa",
      "Pensar tanto sobre uma decisão que fica difícil escolher"
    ],
    "effects": [
      "Decisões adiadas",
      "Perda de oportunidades",
      "Dependência da aprovação alheia",
      "Diminuição das próprias conquistas",
      "Frustração por não confiar no que já sabe ou é capaz de fazer"
    ],
    ...
    "path": [
      "Escolha uma pequena decisão que você vem adiando por insegurança. Em vez de perguntar “Tenho certeza de que consigo?”, experimente perguntar:",
      "O que eu faria agora se confiasse um pouco mais na minha própria capacidade?",
      "Então escolha uma ação pequena e concreta para realizar nas próximas 24 horas.",
      "Você não precisa eliminar toda a insegurança para começar. Pode começar enquanto aprende a confiar em si."
    ],
    "practices": [
      "Reconheça evidências concretas da sua capacidade",
      "Observe quando estiver buscando confirmação externa",
      "Questione a voz que diz que você ainda não está pronta",
      "Tome uma pequena decisão sem pedir validação",
      "Registre pequenas ações feitas apesar da dúvida"
    ],
  ...
  "PROCRASTINAÇÃO": {
    ...
    "signs": [
      ...
      "Começar e ter dificuldade para concluir",
      "Fazer tarefas menores enquanto evita a prioridade",
      "Precisar da urgência para finalmente agir"
    ],
    "effects": [
    ...
    "path": [
      "Escolha uma única coisa que você vem adiando e reduza essa tarefa até encontrar uma ação que possa ser feita em 10 minutos ou menos.",
      "Não é terminar tudo. É apenas romper a inércia.",
      "Qual é a menor ação concreta que posso fazer agora para sair da intenção e entrar em movimento?"
    ],
    "practices": [
      "Divida tarefas grandes em passos pequenos",
      "Use a regra dos 10 minutos para começar",
      "Elimine distrações durante esse pequeno período",
      "Observe o desconforto que aparece antes de agir",
      "Celebre o movimento, não apenas a conclusão"
    ],
