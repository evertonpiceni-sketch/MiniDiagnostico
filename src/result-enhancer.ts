...
function enhance() {
  ...
  const signposts = pattern === 'PROCRASTINAÇÃO' ? `<div class="result-signposts" aria-label="Planejar, começar, conquistar"><span>PLANEJAR</span><span>COMEÇAR</span><span>CONQUISTAR</span></div>` : '';
  ...
  card.innerHTML = `<article class="result-poster">
    ...
    <div class="result-sections">
      ...
      ${content.cycle ? section('cycle','CICLO DA PROCRASTINAÇÃO', `<div class="result-cycle-text">${escapeHtml(content.cycle)}</div>`) : ''}
